...
dir = StringJoin[parentDir, "/auxiliar_data/linear_cycles/nonprimitive/"];
resultDir = StringJoin[parentDir, "/main_data/linear_cycles/"];
dirSmith = StringJoin[resultDir, "smith_form/nonprimitive/"];
...
For[k = 1, k <= length, k++,
	...
	For[d = MINDEG[[k]], d<=MAXDEG[[k]], d++,
		...
		matrixFilename = StringJoin["nonprim_linear_cycles_", suffix];
